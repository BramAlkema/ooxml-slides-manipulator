...
class PPTXTemplate {
  ...
  static createFromTemplate(options = {}) {
    try {
      ...
      // Extract files using OOXMLCore (proper abstraction layer)
      const ooxml = new OOXMLCore(templateBlob);
      ...
      // Use OOXMLCore to compress files
      ooxml.replaceFiles(filesObject);
      return ooxml.generateBlob();
